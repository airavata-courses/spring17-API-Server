...
public class CuratorService {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class pingCuratorProjection_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("pingCuratorProjection", org.apache.thrift.protocol.TMessageType.ONEWAY, 0));
        pingCuratorProjection_args args = new pingCuratorProjection_args();
        args.setProjection(projection);
        args.write(prot);
        prot.writeMessageEnd();
  ...
  public static class acquireLock_args implements org.apache.thrift.TBase<acquireLock_args, acquireLock_args._Fields>, java.io.Serializable, Cloneable, Comparable<acquireLock_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_projection = true && (isSetProjection());
      list.add(present_projection);
      if (present_projection)
        list.add(projection);
      ...
      boolean present_maxWaitMs = true;
      list.add(present_maxWaitMs);
      if (present_maxWaitMs)
        list.add(maxWaitMs);
  ...
  public static class acquireSemaphore_args implements org.apache.thrift.TBase<acquireSemaphore_args, acquireSemaphore_args._Fields>, java.io.Serializable, Cloneable, Comparable<acquireSemaphore_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_acquireQty = true;
      list.add(present_acquireQty);
      if (present_acquireQty)
        list.add(acquireQty);
      ...
      boolean present_maxLeases = true;
      list.add(present_maxLeases);
      if (present_maxLeases)
        list.add(maxLeases);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  LeaseProjection _elem25;
                  for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                  {
                    _elem25 = new LeaseProjection();
                    _elem25.read(iprot);
        ...
        if (incoming.get(0)) {
          {
            ...
            LeaseProjection _elem30;
            for (int _i31 = 0; _i31 < _list29.size; ++_i31)
            {
              _elem30 = new LeaseProjection();
              _elem30.read(iprot);
...
;
  ...
  public static class getLeaderParticipants_args implements org.apache.thrift.TBase<getLeaderParticipants_args, getLeaderParticipants_args._Fields>, java.io.Serializable, Cloneable, Comparable<getLeaderParticipants_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_leaderProjection = true && (isSetLeaderProjection());
      list.add(present_leaderProjection);
      if (present_leaderProjection)
        list.add(leaderProjection);
  ...
  public static class getNodeCacheData_args implements org.apache.thrift.TBase<getNodeCacheData_args, getNodeCacheData_args._Fields>, java.io.Serializable, Cloneable, Comparable<getNodeCacheData_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_cacheProjection = true && (isSetCacheProjection());
      list.add(present_cacheProjection);
      if (present_cacheProjection)
        list.add(cacheProjection);
  ...
  public static class newCuratorProjection_args implements org.apache.thrift.TBase<newCuratorProjection_args, newCuratorProjection_args._Fields>, java.io.Serializable, Cloneable, Comparable<newCuratorProjection_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_connectionName = true && (isSetConnectionName());
      list.add(present_connectionName);
      if (present_connectionName)
  ...
  public static class startLeaderSelector_args implements org.apache.thrift.TBase<startLeaderSelector_args, startLeaderSelector_args._Fields>, java.io.Serializable, Cloneable, Comparable<startLeaderSelector_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_waitForLeadershipMs = true;
      list.add(present_waitForLeadershipMs);
      if (present_waitForLeadershipMs)
        list.add(waitForLeadershipMs);
  ...
  public static class startNodeCache_args implements org.apache.thrift.TBase<startNodeCache_args, startNodeCache_args._Fields>, java.io.Serializable, Cloneable, Comparable<startNodeCache_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_dataIsCompressed = true;
      list.add(present_dataIsCompressed);
      if (present_dataIsCompressed)
        list.add(dataIsCompressed);

      boolean present_buildInitial = true;
      list.add(present_buildInitial);
      if (present_buildInitial)
  ...
  public static class startPathChildrenCache_args implements org.apache.thrift.TBase<startPathChildrenCache_args, startPathChildrenCache_args._Fields>, java.io.Serializable, Cloneable, Comparable<startPathChildrenCache_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_cacheData = true;
      list.add(present_cacheData);
      if (present_cacheData)
        list.add(cacheData);
      ...
      boolean present_startMode = true && (isSetStartMode());
      list.add(present_startMode);
      if (present_startMode)
        list.add(startMode.getValue());
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, startPathChildrenCache_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 5: // START_MODE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.startMode = org.apache.curator.generated.PathChildrenCacheStartMode.findByValue(iprot.readI32());
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, startPersistentEphemeralNode_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 4: // MODE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.mode = org.apache.curator.generated.PersistentEphemeralNodeMode.findByValue(iprot.readI32());
