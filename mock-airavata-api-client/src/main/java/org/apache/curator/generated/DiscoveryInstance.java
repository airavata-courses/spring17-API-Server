...
public class DiscoveryInstance implements org.apache.thrift.TBase<DiscoveryInstance, DiscoveryInstance._Fields>, java.io.Serializable, Cloneable, Comparable<DiscoveryInstance> {
  ...
  public int hashCode() {
    ...
    boolean present_registrationTimeUTC = true;
    list.add(present_registrationTimeUTC);
    if (present_registrationTimeUTC)
      list.add(registrationTimeUTC);
    ...
    boolean present_uriSpec = true && (isSetUriSpec());
    list.add(present_uriSpec);
    if (present_uriSpec)
      list.add(uriSpec);
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DiscoveryInstance struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // SERVICE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.serviceType = org.apache.curator.generated.DiscoveryInstanceType.findByValue(iprot.readI32());
