...
public class PathChildrenCacheEvent implements org.apache.thrift.TBase<PathChildrenCacheEvent, PathChildrenCacheEvent._Fields>, java.io.Serializable, Cloneable, Comparable<PathChildrenCacheEvent> {
  ...
  public int hashCode() {
    ...
    boolean present_cachedPath = true && (isSetCachedPath());
    list.add(present_cachedPath);
    if (present_cachedPath)
      list.add(cachedPath);
        ...
        switch (schemeField.id) {
          ...
          case 2: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = org.apache.curator.generated.PathChildrenCacheEventType.findByValue(iprot.readI32());
