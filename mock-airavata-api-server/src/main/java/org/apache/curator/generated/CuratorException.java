...
public class CuratorException extends TException implements org.apache.thrift.TBase<CuratorException, CuratorException._Fields>, java.io.Serializable, Cloneable, Comparable<CuratorException> {
  ...
  public int hashCode() {
    ...
    boolean present_zooKeeperException = true && (isSetZooKeeperException());
    list.add(present_zooKeeperException);
    if (present_zooKeeperException)
      list.add(zooKeeperException.getValue());

    boolean present_nodeException = true && (isSetNodeException());
    list.add(present_nodeException);
    if (present_nodeException)
      list.add(nodeException.getValue());
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = org.apache.curator.generated.ExceptionType.findByValue(iprot.readI32());
          ...
          case 2: // ZOO_KEEPER_EXCEPTION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.zooKeeperException = org.apache.curator.generated.ZooKeeperExceptionType.findByValue(iprot.readI32());
          ...
          case 3: // NODE_EXCEPTION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.nodeException = org.apache.curator.generated.NodeExceptionType.findByValue(iprot.readI32());
