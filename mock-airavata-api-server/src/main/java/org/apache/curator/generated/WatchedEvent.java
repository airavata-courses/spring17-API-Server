...
public class WatchedEvent implements org.apache.thrift.TBase<WatchedEvent, WatchedEvent._Fields>, java.io.Serializable, Cloneable, Comparable<WatchedEvent> {
  ...
  public int hashCode() {
    ...
    boolean present_keeperState = true && (isSetKeeperState());
    list.add(present_keeperState);
    if (present_keeperState)
      list.add(keeperState.getValue());
        ...
        switch (schemeField.id) {
          case 1: // KEEPER_STATE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.keeperState = org.apache.curator.generated.KeeperState.findByValue(iprot.readI32());
          ...
          case 2: // EVENT_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.eventType = org.apache.curator.generated.EventType.findByValue(iprot.readI32());
