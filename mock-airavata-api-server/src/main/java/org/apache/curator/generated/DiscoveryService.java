...
public class DiscoveryService {
  ...
  public static class getAllInstances_args implements org.apache.thrift.TBase<getAllInstances_args, getAllInstances_args._Fields>, java.io.Serializable, Cloneable, Comparable<getAllInstances_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_providerProjection = true && (isSetProviderProjection());
      list.add(present_providerProjection);
      if (present_providerProjection)
        list.add(providerProjection);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  DiscoveryInstance _elem49;
                  for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                  {
                    _elem49 = new DiscoveryInstance();
                    _elem49.read(iprot);
        ...
        if (incoming.get(0)) {
          {
            ...
            DiscoveryInstance _elem54;
            for (int _i55 = 0; _i55 < _list53.size; ++_i55)
            {
              _elem54 = new DiscoveryInstance();
              _elem54.read(iprot);
  ...
  public static class startDiscovery_args implements org.apache.thrift.TBase<startDiscovery_args, startDiscovery_args._Fields>, java.io.Serializable, Cloneable, Comparable<startDiscovery_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_yourInstance = true && (isSetYourInstance());
      list.add(present_yourInstance);
      if (present_yourInstance)
        list.add(yourInstance);
  ...
  public static class startProvider_args implements org.apache.thrift.TBase<startProvider_args, startProvider_args._Fields>, java.io.Serializable, Cloneable, Comparable<startProvider_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_discoveryProjection = true && (isSetDiscoveryProjection());
      list.add(present_discoveryProjection);
      if (present_discoveryProjection)
        list.add(discoveryProjection);
      ...
      boolean present_providerStrategy = true && (isSetProviderStrategy());
      list.add(present_providerStrategy);
      if (present_providerStrategy)
        list.add(providerStrategy.getValue());

      boolean present_downTimeoutMs = true;
      list.add(present_downTimeoutMs);
      if (present_downTimeoutMs)
        list.add(downTimeoutMs);

      boolean present_downErrorThreshold = true;
      list.add(present_downErrorThreshold);
      if (present_downErrorThreshold)
        list.add(downErrorThreshold);
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, startProvider_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 4: // PROVIDER_STRATEGY
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.providerStrategy = org.apache.curator.generated.ProviderStrategyType.findByValue(iprot.readI32());
