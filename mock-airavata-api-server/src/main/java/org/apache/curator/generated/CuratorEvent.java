...
public class CuratorEvent implements org.apache.thrift.TBase<CuratorEvent, CuratorEvent._Fields>, java.io.Serializable, Cloneable, Comparable<CuratorEvent> {
  ...
  public int hashCode() {
    ...
    boolean present_aclList = true && (isSetAclList());
    list.add(present_aclList);
    if (present_aclList)
      list.add(aclList);

    boolean present_watchedEvent = true && (isSetWatchedEvent());
    list.add(present_watchedEvent);
    if (present_watchedEvent)
      list.add(watchedEvent);

    boolean present_leaderEvent = true && (isSetLeaderEvent());
    list.add(present_leaderEvent);
    if (present_leaderEvent)
      list.add(leaderEvent);

    boolean present_childrenCacheEvent = true && (isSetChildrenCacheEvent());
    list.add(present_childrenCacheEvent);
    if (present_childrenCacheEvent)
      list.add(childrenCacheEvent);
        ...
        switch (schemeField.id) {
          case 2: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = org.apache.curator.generated.CuratorEventType.findByValue(iprot.readI32());
