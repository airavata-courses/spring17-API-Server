...
public class Stat implements org.apache.thrift.TBase<Stat, Stat._Fields>, java.io.Serializable, Cloneable, Comparable<Stat> {
  ...
  public int hashCode() {
    ...
    boolean present_czxid = true;
    list.add(present_czxid);
    if (present_czxid)
      list.add(czxid);

    boolean present_mzxid = true;
    list.add(present_mzxid);
    if (present_mzxid)
      list.add(mzxid);
    ...
    boolean present_cversion = true;
    list.add(present_cversion);
    if (present_cversion)
      list.add(cversion);

    boolean present_aversion = true;
    list.add(present_aversion);
    if (present_aversion)
      list.add(aversion);

    boolean present_ephemeralOwner = true;
    list.add(present_ephemeralOwner);
    if (present_ephemeralOwner)
      list.add(ephemeralOwner);

    boolean present_dataLength = true;
    list.add(present_dataLength);
    if (present_dataLength)
      list.add(dataLength);

    boolean present_numChildren = true;
    list.add(present_numChildren);
    if (present_numChildren)
      list.add(numChildren);

    boolean present_pzxid = true;
    list.add(present_pzxid);
    if (present_pzxid)
      list.add(pzxid);
